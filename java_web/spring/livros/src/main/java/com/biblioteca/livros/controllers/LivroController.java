...
public class LivroController {
	...
	@RequestMapping(value="/alterarLivro/{idLivro}", method=RequestMethod.GET)
	public ModelAndView formAlterarLivro(@PathVariable("idLivro") long idLivro) {
	...
	@RequestMapping(value="/alterarLivro/{idLivro}", method=RequestMethod.POST)
	public String alterarLivro(@Validated Livro livro, LivroController result, RedirectAttributes attributes) {
